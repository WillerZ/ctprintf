...
using philwill::parsed;
int main() {
  constexpr auto hi =
      parsed<char, 'H', 'e', 'l', 'l', 'o', ' ', '%', 's', '!', '\n'>{};
  constexpr auto decimal_formatter = parsed<char, 'D', 'e', 'c', 'i', 'm', 'a',
                                            'l', ':', ' ', '%', 'd', '\n'>{};
  constexpr auto lower_hex_formatter =
      parsed<char, 'h', 'e', 'x', ':', ' ', '%', 'x', '\n'>{};
  constexpr auto upper_hex_formatter =
      parsed<char, 'H', 'E', 'X', ':', ' ', '%', 'X', '\n'>{};
  constexpr auto char_formatter =
      parsed<char, 'c', 'h', 'a', 'r', ':', ' ', '\'', '%', 'c', '\'', '\n'>{};
  ...
  static_assert(
      ...
      "Addition failure (post identity)");
  static_assert(
      std::is_same_v<decltype((parsed<char, 'a'>{} + parsed<char, 'b'>{}) +
                              parsed<char, 'c'>{}),
                     decltype(parsed<char, 'a'>{} +
                              (parsed<char, 'b'>{} + parsed<char, 'c'>{}))>,
