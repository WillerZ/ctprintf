...
using philwill::UpperHexIntegralArgument;
...
UpperHexIntegralArgument<CharT> argumentFrom(Int theInt) {
  return {theInt};
}

template <typename CharT>
int test0(UpperHexIntegralArgument<CharT> const& test) {
...
template <typename CharT>
int test1(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test2(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test3(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test4(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test5(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test6(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test7(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test8(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test9(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test10(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test11(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test12(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test13(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test14(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test15(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(1 == test.size() && "size() must be 1");
  bool matched = false;
...
template <typename CharT>
int test16(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
...
template <typename CharT>
int test255(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
  assert(2 == test.size() && "size() must be 2");
  bool matched = false;
...
template <typename CharT>
int test65535(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
...
template <typename CharT>
int test4294967295(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
...
template <typename CharT>
int test18446744073709551615(UpperHexIntegralArgument<CharT> const& test) {
  philwill::tests::correctVisitorTest(test);
